...
export default function Admin(){
    ...
    let getData=async (value)=>{
        console.log("hget")
        try{
            let response=await fetch(`https://e-store-ir0d.onrender.com/products/appliances?searchExp=${value}`)
    ...
    function onclick(event){
        ...
        console.log(id)
        fetch(`https://e-store-ir0d.onrender.com/products/appliances/${id}`, {
        method: 'DELETE'
        })
        getData()
    }
