...
export default function About(){
    ...
    <div className="socials flex row justify-between w-[75%] ml-[12.5%] mr-[12.5%] pr-[10px] pl-[10px] bg-gradient-to-r from-[rgb(238,238,238)] to-white rounded-md">
    <div className="igCont">
        <img className="ig h-[50px]" src="../images/igIcon.jpeg"/>
    </div>
    <div className="fbCont">
        <img className="fb h-[50px]" src="../images/fbIcon.png"/>
    </div>
    <div className="wmsgCont" >
        <img className="wmsg h-[50px]" src="../images/WhatsAppIcon.png"/>
    </div>
    <div className="mailCont">
        <img className="mail h-[50px]" src="../images/mailIcon.jpeg"/>
    </div>
    </div>
    </div>
    </>
